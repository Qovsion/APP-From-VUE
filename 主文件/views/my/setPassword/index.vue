<template>
  <div class="centent">
    ...
    <p class="bot">
      已有账户？
      <span style="color:rgb(74,88,255);font-size:12px" @click="$router.push('/yzmlogin')">快速登录</span>
    </p>
  </div>
</template>
  ...
  methods: {
    ...
    setPasswordApi () {
      ...
      this.$https({
        method: 'post',
        data: dada,
        url: 'https://www.125yan.com/interface.php?s=/Home/UserApi/mobilePhoneRegister'
      }).then(res => {
