...
export default {
  ...
  methods: {
    turn (id, i) {
      if (i === 0) {
        this.$router.push({ path: `/AdvancedStudies/${id}`, query: { lx: this.Zzss[i].lx, name: this.Zzss[i].lxmc } })
      } else {
